...
const products = [
  ...
  { src: "/product/biomaterial.jpg", desc: "A shape-memory biomaterial created by combining bacterial cellulose (BC) with other biopolymers. This composite responds to stimuli like temperature or moisture, allowing it to return to its original shape while remaining biocompatible and biodegradable.It also has oil adherence capacity which is useful for oil spill cleanup." },
